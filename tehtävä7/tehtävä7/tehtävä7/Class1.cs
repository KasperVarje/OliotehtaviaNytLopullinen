    ...
    class Hissi
    {
        ...
        public int Kerros
        {
            set
            {
                if (value < minKerros)
                {
                    Console.WriteLine("Virheellinen kerros annettu. Annettu arvo " + value + " on pienempi kuin " + minKerros);
                }
                else if (value > maxKerros)
                {
                    Console.WriteLine("Virheellinen kerros annettu. Annettu arvo " + value + " on suurempi kuin " + maxKerros);
                }
                else
                {
                    kerros = value;
